 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(5);var warning=__webpack_require__(7);var ExecutionEnvironment=__webpack_require__(13);var _assign=__webpack_require__(4);var emptyFunction=__webpack_require__(3);var EventListener=__webpack_require__(14);var getActiveElement=__webpack_require__(15);var shallowEqual=__webpack_require__(8);var containsNode=__webpack_require__(16);var focusNode=__webpack_require__(17);var emptyObject=__webpack_require__(6);var checkPropTypes=__webpack_require__(9);var hyphenateStyleName=__webpack_require__(36);var camelizeStyleName=__webpack_require__(38);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.closeDescription = _this.closeDescription.bind(_this);
    _this.addBool = _this.addBool.bind(_this);
    _this.handleSubmit = _this.handleSubmit.bind(_this);
    _this.handleCity = _this.handleCity.bind(_this);
    _this.handleZip = _this.handleZip.bind(_this);
  ...
  _createClass(App, [{
    key: "inputSearch",
    value: function inputSearch(search) {
      var _this2 = this;

      var key = "278bf3d4ead6129ce614dda7c6de6682";
      _axios2.default.get("http://api.brewerydb.com/v2/" + search + "&key=" + key).then(function (response) {
    ...
    key: "handlePage",
    value: function handlePage(i) {

      var page = "&p=" + i;
      var currentSearch = this.state.input;
      var newSearch = currentSearch + page;
    ...
    value: function addBool() {
      this.setState({
        data: this.state.data.map(function (show) {
    ...
    key: "showDescription",
    value: function showDescription(id, bool) {
      this.setState({
        data: this.state.data.map(function (show) {
          if (id === show.id) {
            return _extends({}, show, {
    ...
    value: function closeDescription(id, bool) {
      this.setState({
        data: this.state.data.map(function (show) {
          if (id === show.id) {
            return _extends({}, show, {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "h4",
              null,
              "simple app to find your favorite breweries"
            )
          )
        ),
        _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "button",
              { className: "btn btn-success btn-block form-control", id: "submit" },
              "Search"
            )
          )
        )
...
var List = exports.List = function (_Component) {
  ...
  function List() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = List.__proto__ || Object.getPrototypeOf(List)).call.apply(_ref2, [this].concat(args))), _this), _this.changePage = function (id) {
      _this.props.page(id);
    }, _this.renderList = function () {
      // console.log(this.props.currentSearch)
      var iconImages = void 0,
          mediumImages = void 0,
          current = void 0;
      if (!_this.props.currentSearch) {
        return null;
      }
      var arr = [];
      for (var i = 0; i < _this.props.pages; i++) {
        arr[i] = i + 1;
      }
      ...
      return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              arr.map(function (num, i) {
                // console.log(num);
                return _react2.default.createElement(Anchor, {
                  key: i,
                  id: num,
                  pageChange: _this.changePage
                });
              })
            )
          )
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            null,
            _this.props.currentSearch.map(function (data, i) {

              iconImages = _typeof(data.brewery.images) === "object" ? data.brewery.images.icon : "";

              mediumImages = _typeof(data.brewery.images) === "object" ? data.brewery.images.medium : "";

              return _react2.default.createElement(_ShowList.ShowList, {
                key: data.id,
                id: data.id,
                number: i,
                showDesc: _this.props.handleDesc,
                closeDesc: _this.props.handleClose,
  ...
  _createClass(List, [{
    key: "render",
    value: function render() {
      return this.props.showList ? this.renderList() : this.emptyList();
    }
  }]);
...
var ShowList = exports.ShowList = function ShowList(_ref) {
  var showDesc = _ref.showDesc,
      closeDesc = _ref.closeDesc,
      number = _ref.number,
      id = _ref.id,
      name = _ref.name,
      iconImages = _ref.iconImages,
      mediumImages = _ref.mediumImages,
  ...
  var normalList = function normalList() {
    return _react2.default.createElement(
      "li",
      { className: "list-group-item " },
      _react2.default.createElement(
        "span",
        { className: "icon col-lg-2" },
        _react2.default.createElement("img", { src: iconImages })
      ),
      _react2.default.createElement(
        "span",
        { className: "listText col-lg-2" },
        name
      ),
      _react2.default.createElement(
        "span",
      ...
      _react2.default.createElement(
        "button",
        { className: "btn btn-primary descBtn col-lg-2 pull-right", onClick: desc },
        "See Description"
      )
    );
  };

  var descList = function descList() {
    return _react2.default.createElement(
      "li",
      { className: "list-group-item showDesc" },
      _react2.default.createElement(
        "div",
        { className: "descText" },
        _react2.default.createElement("img", { src: mediumImages })
      ),
      _react2.default.createElement(
        "div",
        { className: "descText" },
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "a",
          { href: website, className: "web" },
          website
        ),
        _react2.default.createElement(
          "button",
          { className: "btn btn-block btn-link", onClick: close },
          _react2.default.createElement(
            "h4",
            null,
            "Close"
  ...
  return !descState ? normalList() : descList();
};
